import { FormActions } from "#frontend/hooks/useForm";
...
export function getExerciseFields(exercise?: ExerciseSchemaInterface | null) {
  return [
    ...
    },
    {
      ...
      description:
        "Put in anything you'd like to keep in mind about this exercise",
      id: "notes",
    ...
    },
    {
      ...
      description:
        "Unilateral exercises are doubled when counting stats. Ex.) Dumbbell Bicep Curls",
      id: "unilateral",
      initialObj: {
        type: FormActions.SET_VALUE,
        payload: { field: "unilateral" },
      },
      inputTag: "input",
      label: "Unilateral?",
      name: "unilateral",
